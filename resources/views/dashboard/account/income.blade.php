  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l8">
        <h5 class="breadcrumbs-title">Income Statement</h5>
        <ol class="breadcrumb">
...
<div class="containerlarge">
    ...
    <div class="raw">
        <div class="col s12 m12 l8">
            <p class="caption">Income Statement</p>
    ...
    <div id="table-datatables">
            ...
            <div class="col s12 m12 l5">
                ...
                <h4 class="header2">Add Statement</h4>
                    ...
                    <form  method="POST" class="col s12" action="{{ url('dashboard/account/incomeadded') }}"  enctype="multipart/form-data">
                                {{ csrf_field() }}
