  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l8">
        <h5 class="breadcrumbs-title">Add Suppliers</h5>
        <ol class="breadcrumb">
...
<div class="containerlarge">
    ...
    <p class="caption">Add New Suppliers</p>
        ...
        <div id="basic-form" class="section">
            <div class="row">
                 <div class="col s12 m12 offset-l2 l8">
                        ...
                        <div class="row">
                            <form  method="POST" class="col s12" action="{{ url('dashboard/suppliers/supplieradded') }}"  enctype="multipart/form-data">
                                {{ csrf_field() }}

                        <div class="row">
                            <div class="input-field col s12">
                                <i class="mdi-action-shopping-cart prefix"></i>
                                    <input id="supplier_name" type="text"  name="supplier_name" required autofocus>
                        ...
                        <div class="row margin">
                            <div class="input-field col s12">
                                ...
                                <input id="supplier_address" type="text" name="supplier_address" required="required"  >      
                            ...
                            <div class="input-field col s12">
                                ...
                                <input id="supplier_number" type="text" name="supplier_number" required="required" >      
                            ...
                            <div class="input-field col s12">
                                ...
                                <input id="supplier_email" type="email" name="supplier_email" required="required"  >      
