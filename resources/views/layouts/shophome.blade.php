          ...
          <div class="topbar__content row">
            <div class="col-sm-3 col-sm-offset-1 hidden-xs">
                <div class="topbar__cart">
                    <a href="{{ url("/home") }}" class="btn btn-transparent"><i class="fa fa-home"></i><span>Dashboard</span></a>
            ...
            <div class="col-sm-4 topbar__logo"><a href="{{ url("/shop") }}"><img src="{{ asset('images/3.png') }}" alt="" class="topbar__logo__normal"><img src="{{ asset('images/3.png') }}" alt="" class="topbar__logo__small"></a>
            </div>
            <div class="col-sm-4 hidden-xs">
                <div class="topbar__cart">
                    ...
                    <div class="top-right links">
                        @auth
                        <a  class="btn btn-transparent" data-toggle="modal" href='#modal-id'>
