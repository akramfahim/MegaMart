          ...
          <div class="panel panel-default sidebar-menu">
            ...
            <div class="panel-body">
              ...
              @foreach($item_categories->all() as $item_category)
                ...
                {{ count($itemstotal->where('item_category','=',$item_category->id))
                }}
                </span></a></li>
              @endforeach 
              </ul>
        ...
        <div class="col-md-9">
                  ...
                  <div class="form-inline">
                    <div class="col-md-6 col-sm-6">
                      <div class="products-number"><strong>Show</strong> 
                        <a href="{{ route('shopitemlist',['sort'=> request('sort'),'show'=>'12' ]) }}" 
                        @if( $requestShow=='12')
                        ...
                        >
                        12</a>
                        <a href="{{ route('shopitemlist',['sort'=> request('sort'),'show'=>'24' ]) }}" 
                        @if( $requestShow==='24')
                        class="btn btn-default btn-sm btn-primary"
                        @else
                        class="btn btn-default btn-sm "
                    ...
                    <div class="col-md-6 col-sm-6">
                      ...
                      <a href="{{ route('shopitemlist',['show'=> request('show'),'sort'=>'updated_at' ]) }}" 
                        ...
                        >
                        Newest</a>
                        <a href="{{ route('shopitemlist',['show'=> request('show'),'sort'=>'item_price'  ]) }}" 
          ...
          @foreach($items->all() as $item)
                ...
                <div class="col-md-4 col-sm-6">
                  <div class="product"> 
                    <div class="image"><a href="{{ url("/shop/product/{$item->id}") }}"> <img src="{{$item->item_image}}" alt="" class="img-responsive"></a>
